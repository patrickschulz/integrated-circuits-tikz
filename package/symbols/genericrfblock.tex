\tikzset{
    circuits/rfcomp/width/.initial = 1.2cm,
    circuits/rfcomp/height/.initial = 0.6cm,
    circuits/rfcomp/port width/.initial = 2.5pt,
    circuits/rfcomp/port height/.initial = 2.5pt,
    rfcomp/.style = {rfcompshape, draw, thick}
}

\pgfdeclareshape{rfcompshape}
{
    \saveddimen{\width}{\pgf@x=\pgfkeysvalueof{/tikz/circuits/rfcomp/width}}
    \saveddimen{\height}{\pgf@x=\pgfkeysvalueof{/tikz/circuits/rfcomp/height}}
    \saveddimen{\portwidth}{\pgf@x=\pgfkeysvalueof{/tikz/circuits/rfcomp/port width}}
    \saveddimen{\portheight}{\pgf@x=\pgfkeysvalueof{/tikz/circuits/rfcomp/port height}}
    \savedanchor{\centerpoint}{\pgfpointorigin}
    \savedanchor{\diffplus}{%
        \pgfpointadd%
        {\pgfpointorigin}%
        {\pgfpoint%
            {-0.5 * \pgfkeysvalueof{/tikz/circuits/rfcomp/width}}%
            {0.25 * \pgfkeysvalueof{/tikz/circuits/rfcomp/height}}
        }%
    }
